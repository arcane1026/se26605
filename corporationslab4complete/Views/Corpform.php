...
<?php
//var_dump($corp);
//this form is used to add or update corps to our database. 
$id = "";
//this function will determine if we are displaying an empty form for create or a populated form for update. 
if ($corp['id']>0){
	$id = "?id=" . $corp['id'];
}
?>
